...
public class Leetcode3604 {
    private static Map<Integer, TreeSet<Integer>> mp = new HashMap<>();

    private static void dfs(int node, List<Integer>[] adj, boolean[] visited, int id, int[] ids) {
        visited[node] = true;
        ids[node] = id;
    ...
    public static void main(String[] args) {
        processQueries(5, new int[][] { { 1, 2 }, { 2, 3 }, { 3, 4 }, { 4, 5 } },
